...
for d in roomGraph[0][1]:
    traversal_graph[0][d] = '?'
# Add a room and its adjacent room
# def add_room_traverse(id, l):
#     traversal_graph[id]
...
def traverse_maze():
    ...
    get_path(player.currentRoom.id)
    ...
    #         visited.update({room:path})

    #         for exit in room.get
